...
To run the game, you must obtain a free API key from api.nasa.gov. Save the key as NASA_API_KEY=your_key_here in a file named .env in the root directory. Then, install the requirements and run main.py
